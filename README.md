...
| `definitions/` | YAML-LD test definitions (format 0.2.0, frozen): mirror and extend lws-test-suite, contributed back as JSON-LD; the engine for them is to be generated (DECISIONS.md D-0047) |
